  ...
  let webpackConfig = {
    ...
    resolve: {
      ...
      alias: {
        ...
        components: path.resolve(appRootDir.get(), 'shared', 'components', 'Yrgo'),
        yrgo: path.resolve(appRootDir.get(), 'shared', 'components', 'Yrgo'),
        styles: path.resolve(appRootDir.get(), 'shared', 'styles'),
        assets: path.resolve(appRootDir.get(), 'shared', 'assets'),
        store: path.resolve(appRootDir.get(), 'shared', 'store'),
      },
    },
