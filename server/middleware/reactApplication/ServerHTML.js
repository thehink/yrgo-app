...
function ServerHTML(props) {
  ...
  const headerElements = removeNil([
    ...
    stylesheetTag('//cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick.min.css'),
    stylesheetTag('//cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.6.0/slick-theme.min.css'),
  ]);
